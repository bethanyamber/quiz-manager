            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        This is where you update your quiz details.
                    </p>
                </div>
                <div class="md:mt-0 md:col-span-2">
                    <form class="space-y-6 -mt-6" action="{{ route('quizzes.update', $quiz->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="3"
                                          ...
                                          placeholder="A description for my quiz.">{{old('description', $quiz->description )}}</textarea>
                            </div>
                            @error('description')
                            <p class="text-red-400 text-xs">{{$message}}</p>
                            @enderror
