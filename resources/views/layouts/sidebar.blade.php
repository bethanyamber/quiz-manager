<div class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64">
        ...
        <div class="flex flex-col flex-grow border-r border-gray-200 pt-4 pb-4 bg-white overflow-y-auto">
                ...
                <nav class="flex-1 px-2 bg-white space-y-1">
                    <a href="/"
                       class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <svg class="text-gray-400 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg"
                             fill="none"
                    ...
                    <a href="/quizzes"
                       class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        ...
                        @if(Auth::user()->type === 'edit') All Quizzes @else Quizzes @endif
                    </a>
